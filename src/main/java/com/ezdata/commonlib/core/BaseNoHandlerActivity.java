 ...
 * Date：2017/2/6
 */
public abstract class BaseNoHandlerActivity extends AppCompatActivity {

    // 管理运行的所有的activity
    protected final static List<BaseNoHandlerActivity> mActivitys = new LinkedList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * 不使用handler，否则底部的bar不能正常使用
         */
//        handler.post(new Runnable() {
//            @Override
//            public void run() {
                BaseNoHandlerActivity.this.initToolbar(save);
                BaseNoHandlerActivity.this.initViews(save);
                BaseNoHandlerActivity.this.initData();
                BaseNoHandlerActivity.this.initListeners();
//            }
//        });
